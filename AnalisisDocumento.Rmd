...
```
El p-value indica una probabilidad del 7.4% de obtener esta diferencia entre los valores de ROC para ambos modelos por pura casualidad. No es una evidencia suficientemente fuerte, por lo tanto se puede considerar el rendimiento de ambos modelos equiparables.
